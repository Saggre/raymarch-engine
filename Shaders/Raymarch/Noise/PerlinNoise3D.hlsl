...
float PerlinNoise_Octaves(float3 inCoord, float scale, float3 speed, uint octaveNumber, float octaveScale,
...
//Classic Perlin noise with octaves
float PeriodicPerlinNoise_Octaves(float3 inCoord, float scale, float3 speed, uint octaveNumber, float octaveScale,
                                  float octaveAttenuation, float3 period, float time)
{
    float output = 0.0f;
    float weight = 1.0f;
