...
namespace EconSim.Terrain
{
    public static class Util
    {
        ...
        public static Color GetTerrainColor(this TerrainType terrainType)
        {
            ...
            {
                return new Color(0.1f, 0.8f, 0.2f, 1);
            }

            if (terrainType == TerrainType.Water)
            {
                return new Color(0.0f, 0.0f, 1.0f, 1);
            }

            if (terrainType == TerrainType.Ocean)
            {
                return new Color(0.0f, 0.2f, 0.6f, 1);
            }
            ...
            {
                return new Color(0.3f, 0.5f, 0.95f, 1);
            }

            return new Color(1.0f, 0.0f, 1.0f, 1);
        }
